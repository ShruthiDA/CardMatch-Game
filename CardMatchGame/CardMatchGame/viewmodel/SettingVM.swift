...
class SettingVM : ObservableObject{
    ...
    init(){
        ...
        let t2 = ThemeColorSet(id: 2, c1: "FECCBB",c2: "6EB5C0",c3: "E2E8E4",c4: "90AFC5",c5: "A8E0CC")
        ...
        let t5 = ThemeColorSet(id: 5, c1: "FF8b88",c2: "99B898",c3: "EDE574",c4: "FF847C",c5: "FECEAB")
